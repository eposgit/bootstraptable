...
(function ($) {
  $.fn.extend({
    tableExport: function (options) {
      ...
      if (defaults.type == 'customexcel') {

        if (defaults.customExcelCallback != null){
            defaults.customExcelCallback();
        }

      } else if ( defaults.type == 'csv' || defaults.type == 'tsv' || defaults.type == 'txt' ) {
